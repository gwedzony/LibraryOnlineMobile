...
namespace Database.Migrations
{
    ...
    [Migration("20240330180719_CreateInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Data.BookScheme.ChapterNames", b =>
                {
            ...
            modelBuilder.Entity("Database.Data.BookScheme.TableOfContent", b =>
                {
                    b.Property<int>("tocId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Database.Data.BookScheme.ChapterNames", b =>
                {
                    b.HasOne("Database.Data.BookScheme.TableOfContent", "TableOfContent")
                        .WithMany("chapterNames")
                        .HasForeignKey("TocId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TableOfContent");
                });

            modelBuilder.Entity("Database.Data.BookScheme.TableOfContent", b =>
                {
                    b.HasOne("Database.DATA.CMS.Book", "Book")
                        .WithOne("TableOfContent")
                        .HasForeignKey("Database.Data.BookScheme.TableOfContent", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
